...
public class SnsGoogleLoginController {
    /**
     * 로그 출력.
     */
     ...
     * 기본 주소.
     */
    private final String thisUrl = "google";
    ...
    // http://localhost:8889/google/snscallback,    encodeURIComponent('http://localhost:8889/google/snscallback')
    //개발
//    private static final String callBackURL = "http%3A%2F%2Fpips.daewooenc.com%3A8889%2Fgoogle%2Fsnscallback";
    // 상용
//    private String callBackURL = "http%3A%2F%2F"+prugioDomain+"%3A8889%2Fgoogle%2Fsnscallback";
//    private static final String naverCallBackURL = "https%3A%2F%2Fauth.expo.io%2Fgoogle%2Fsnscallback";
//    private static final String kakaoCallBackURL = "http://localhost/8889/google/snscallback";
    // 개인
    /*
...
//    private static final String naverRequestUrl = "https://nid.naver.com/oauth2.0/authorize?client_id=" + naverClientId + "&response_type=code&redirect_uri="+ naverCallBackURL + "&state=";
    ...
    public String oauth(Model model, HttpServletRequest request, CommunicationAuthCode communicationAuthCodeDB) {
        ...
        String callBackURL = "http%3A%2F%2F"+prugioDomain+"%3A8889%2Fgoogle%2Fsnscallback";

        if(request.isSecure()){
            callBackURL = "https%3A%2F%2F"+prugioDomain+"%3A18889%2Fgoogle%2Fsnscallback";
        } else {
            callBackURL = "http%3A%2F%2F"+prugioDomain+"%3A8889%2Fgoogle%2Fsnscallback";
        }
        ...
        if(commnunityState != null && !"".equals(commnunityState)) {
            if ("naver".equals(snsType)) {
                ...
                logger.debug("snsAuthCode================" + snsAuthCode);
                    ...
                    String redirect_uri = "http://smarthome.prugio.com:8889/google/snscallback";
                    if(request.isSecure()){
                        redirect_uri = "https://smarthome.prugio.com:18889/google/snscallback";
                    } else {
                        redirect_uri = "http://smarthome.prugio.com:8889/google/snscallback";
                    }
                ...
                logger.debug("callBackErrorCode================[" + callBackErrorCode + "]");
                    ...
                    if (!"error".equals(callBackErrorCode) && callBackErrorCode == null && !"".equals(callBackErrorCode)) {
                        String accessTokenReqUrl = getAccessTokenUrl(commnunityState, snsAuthCode, snsType, "");
                        logger.debug("accessTokenReqUrl================" + accessTokenReqUrl);
                        //String redirect_uri = "http://localhost:8080/google/snscallback";
                        ...
                        redirect_uri = "http://pips.daewooenc.com:8889/google/snscallback";
